...
namespace BlazorContextMenu
{
    public static class BlazorContextMenuDefaults
    {
        ...
        public static string DefaultMenuItemCssClass { get; set; } = "blazor-context-menu__item--default";
        public static string DefaultMenuItemDisabledCssClass { get; set; } = "blazor-context-menu__item--default-disabled";
